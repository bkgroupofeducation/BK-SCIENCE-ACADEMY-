...
const CoachingGuidelinesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Header */}
      <section className="relative overflow-hidden bg-brand-dark py-12 md:py-16">
      ...
      {/* Philosophy Section */}
      <section className="py-10 bg-brand-gray border-y border-gray-100 overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16 max-w-6xl mx-auto">
            <div className="lg:w-1/2">
              <h2 className="text-[24px] sm:text-3xl md:text-4xl lg:text-5xl whitespace-nowrap font-black text-brand-dark uppercase tracking-tighter leading-none mb-8">
                Consistency over <span className="text-brand-red">Intensity</span>
              </h2>
            ...
            <div className="lg:w-1/2 relative">
               <div className="relative z-10 bg-brand-dark p-12 rounded-[3rem] shadow-2xl skew-x-1">
                  <blockquote className="text-2xl font-black text-white leading-tight">
