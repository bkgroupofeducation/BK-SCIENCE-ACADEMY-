...
const ResultDashboard = () => {
  ...
  const handleFetchResults = async (targetId = studentId) => {
    ...
    const mockData = {
      'BK-171-101': {
        student: { name: 'Nasimul Nayon Ontar', dept: 'Computer Science Dept', batch: 'Batch 04', studentId: 'BK-171-101', avatar: '/assets/ranker1.png' },
      ...
      'BK-171-103': {
        student: { name: 'Amit Raj', dept: 'JEE Advanced', batch: '2026-27', studentId: 'BK-171-103', avatar: '/assets/ranker2.png' },
  ...
  return (
    <div className="min-h-screen bg-surface-1 font-sans text-slate-700 pt-28 md:pt-36 pb-12 relative overflow-hidden">
      ...
      <div className="relative z-10 pt-2 md:pt-4 no-print">
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-white border border-gray-100 p-1 md:p-2 rounded-[18px] md:rounded-[24px] flex flex-nowrap gap-1.5 md:gap-2 w-full lg:w-fit overflow-x-auto scrollbar-hide shadow-lg">
            {['Live Results', 'JEE', 'NEET', 'MHT-CET'].map((item) => (
              <button 
                key={item}
      ...
      <header className="relative z-20 pt-6 pb-4 no-print bg-white border-b border-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 printable-area animate-fade-up">
              ...
              <div className="hidden print:flex flex-col items-center text-center mb-8 pb-8 border-b-2 border-slate-100">
                 <div className="bg-brand-dark px-10 py-2.5 rounded-lg text-white font-black text-2xl mb-4 tracking-widest uppercase">BK Science Academy</div>
                 <h1 className="text-3xl font-black uppercase tracking-tight text-brand-dark">{track} EVALUATION DOCUMENT</h1>
                 <p className="text-[10px] font-bold text-slate-400 mt-2 tracking-widest tracking-tighter">Connected to MongoDB Database Instance</p>
              ...
              <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-md print:border-none print:shadow-none">
                ...
                <div className="hidden print:flex justify-between items-end mt-12 bg-white pb-8 border-t border-slate-50 pt-10">
                   ...
                   <div className="flex flex-col items-center gap-3 pr-8">
                     ...
                     <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest text-center">Verify: BK-ID-{studentId}</p>
                   </div>
                </div>
              </div>
            </div>
