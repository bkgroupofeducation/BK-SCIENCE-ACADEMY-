...
const InputField = ({ label, placeholder, type = "text", name, value, onChange, ...props }) => (
  <div className="flex flex-col gap-2 group">
    <label className="text-xs font-black text-indigo-950/80 uppercase tracking-widest group-focus-within:text-brand-red transition-colors">{label}</label>
    <input 
      type={type} 
      value={value}
  ...
  if (submittedData) {
    return (
      <div className="min-h-screen bg-white relative overflow-hidden animate-fade-scale">
        ...
        <div className="container mx-auto px-5 md:px-8 pt-12 md:pt-16 pb-12 md:pb-16">
    ...
    <div className="min-h-screen bg-white relative overflow-hidden animate-fade-scale">
      ...
      <div className="container mx-auto px-5 md:px-8 pt-12 md:pt-16 pb-12 md:pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-10 animate-fade-up stagger-1">
          ...
          <div className="bg-white rounded-[40px] md:rounded-[50px] lg:rounded-[60px] shadow-[0_50px_100px_-20px_rgba(30,27,75,0.2)] p-6 md:p-10 lg:p-16 border border-gray-100 animate-fade-up stagger-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
              ...
              <div className="grid grid-cols-2 gap-4">
                <SelectField label="Gender" options={["Male", "Female", "Transgender", "Other"]} name="gender" value={formData.gender} onChange={handleChange} />
                <InputField label="Date of Birth" placeholder="DD/MM/YYYY" type="date" name="dob" value={formData.dob} onChange={handleChange} max={new Date().toISOString().split('T')[0]} min="1900-01-01" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
              <SelectField label="Program" options={["JEE Main + Advanced", "NEET (UG)", "Foundation (Pre-Nurture)"]} name="program" value={formData.program} onChange={handleChange} />
