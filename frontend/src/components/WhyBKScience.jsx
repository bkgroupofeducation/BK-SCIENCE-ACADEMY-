...
const WhyBKScience = ({ navigateTo }) => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative pt-8 pb-6 md:pt-10 md:pb-8 bg-brand-dark overflow-hidden">
      ...
      <section className="py-6 md:py-8 bg-brand-gray relative overflow-hidden">
      ...
      <section className="py-4 md:py-6 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="bg-brand-gray rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden">
      ...
      {/* Testimonial / Quote */}
      <section className="py-6 md:py-8 bg-brand-red text-white overflow-hidden relative">
