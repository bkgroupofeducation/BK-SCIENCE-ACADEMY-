...
const GrievancePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-12 md:py-16 bg-brand-dark overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-6">
            Feedback & <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-orange-500">Grievance</span>
          </h1>
      ...
      {/* Form Section */}
      <section className="py-10 md:py-12 -mt-12">
