        ...
        <div className="bg-white p-12 rounded-3xl shadow-xl transition-all duration-500 min-h-[400px]">
          {activeTab === 'desc' && (
            <div className="animate-in fade-in slide-in-from-bottom-5 duration-500">
              <h3 className="text-3xl font-bold mb-8 text-brand-dark">Target: JEE 12th Advanced 2027</h3>
              <div className="grid md:grid-cols-2 gap-12 text-lg text-gray-600 leading-relaxed">
                <div>
                  <p className="mb-6">Specially designed for students currently in Class 11 moving to Class 12. This program focuses on strengthening core concepts and advanced problem-solving techniques.</p>
                ...
                <div className="bg-brand-gray p-8 rounded-2xl border border-gray-100">
                  <h4 className="font-bold text-xl mb-4">Program Highlights</h4>
                  <p>Expert faculty led lectures, regular assessment tests, and personalized performance analysis to ensure student success.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="animate-in fade-in slide-in-from-bottom-5 duration-500">
              <div className="max-w-4xl mx-auto">
                <div className="bg-brand-red p-10 rounded-t-3xl text-white text-center">
                  <h3 className="text-3xl font-black uppercase tracking-widest mb-2">Standard Fees Structure</h3>
                  <p className="opacity-80">Course: Enthuse Batch (12th Advanced)</p>
                </div>
                <div className="border-x border-b border-gray-100 rounded-b-3xl overflow-hidden divide-y divide-gray-100">
                  <div className="flex justify-between p-8 text-xl">
                    ...
                    <span className="font-black text-brand-dark">Included</span>
                  </div>
                  <div className="flex justify-between p-8 text-xl">
                    <span className="font-medium text-gray-600">Tuition Fee</span>
                    <span className="font-black text-brand-dark">₹1,50,000 (2-Year Total)</span>
                  </div>
                  <div className="flex justify-between p-8 text-3xl bg-brand-gray">
                    <span className="font-black text-brand-dark uppercase tracking-tighter">Total Course Fee</span>
                    <span className="font-black text-brand-red">₹1,50,000 (2-Year Total)*</span>
                  </div>
                </div>
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-brand-yellow/10 p-8 rounded-2xl border-2 border-brand-yellow/30 flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="font-bold text-xl">BK Champions Test Scholarship</h4>
                      <p className="text-gray-600 text-sm">Unlock up to 100% scholarship based on your performance.</p>
                    </div>
                  </div>
                  <div className="bg-blue-50 p-8 rounded-2xl border-2 border-blue-100 flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="font-bold text-xl">Special Discount?</h4>
                      <p className="text-gray-600 text-sm">Call: +91 88883 01363 for merit-based exceptions.</p>
                    </div>
                  </div>
                </div>
                <p className="mt-8 text-xs text-center text-gray-400 font-medium">* GST (18%) additional as per Govt. norms. Study material kit fee is non-refundable.</p>
              </div>
            </div>
          )}
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={i} className="p-8 border border-gray-100 rounded-3xl hover:border-brand-red transition-all group group-hover:bg-brand-gray shadow-md">
                    ...
                    <h4 className="text-2xl font-bold mt-4">{batch.title}</h4>
                    <p className="text-gray-500 mt-2 font-medium">Commencement Date: {batch.date}</p>
                    <button className="mt-8 w-full py-3 rounded-full border-2 border-brand-red text-brand-red font-bold transition group-hover:bg-brand-red group-hover:text-white">
                      View Schedule
                    </button>
                  </div>
                ))}
