...
const CareersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center bg-brand-dark overflow-hidden pt-32 pb-16 lg:pt-40 lg:pb-24">
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-16 bg-brand-red relative overflow-hidden">
