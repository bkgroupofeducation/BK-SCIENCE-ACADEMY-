...
const BlogPage = ({ navigateTo }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Editorial Hero */}
      <section className="relative pt-16 pb-12 md:pt-20 md:pb-20 bg-brand-dark overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className={`max-w-4xl transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-10">
              Insights For <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-yellow to-orange-400">Future Scholars.</span>
            </h1>
      ...
      {/* Newsletter */}
      <section className="py-12 bg-brand-gray relative overflow-hidden rounded-[3rem] mx-4 md:mx-10 mb-10">
        <div className="container mx-auto px-6 relative z-10">
