  ...
  <div className="flex flex-col gap-2 group relative">
    ...
    <div className="relative overflow-hidden rounded-2xl">
      ...
      <input 
        ...
        className="w-full bg-white border-2 border-gray-300 rounded-2xl pl-14 pr-6 py-4 font-bold text-brand-dark focus:border-brand-red focus:bg-white transition-all duration-500 text-sm shadow-sm hover:shadow-md outline-none placeholder:text-gray-400"
        onChange={onChange}
      />
  ...
  <div className="flex flex-col gap-2 group relative">
    ...
    <div className="relative overflow-hidden rounded-2xl">
      ...
      <select 
        value={value}
        name={name}
        className="w-full bg-white border-2 border-gray-300 rounded-2xl pl-14 pr-12 py-4 font-bold text-brand-dark focus:border-brand-red focus:bg-white transition-all duration-500 text-sm shadow-sm hover:shadow-md outline-none appearance-none cursor-pointer"
        onChange={onChange}
      >
...
const AdmissionForm = () => {
        ...
        <div className="max-w-2xl w-full bg-white rounded-[40px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] p-12 text-center relative overflow-hidden">
          ...
          <div className="bg-brand-gray/50 rounded-3xl p-8 mb-10 text-left border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase">Registration ID</p>
                <p className="font-black text-brand-dark uppercase">BK-2026-{submittedFormNumber || (formData.mobile ? formData.mobile.slice(-4) : 'XXXX')}</p>
              </div>
              <div>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <button 
              onClick={() => {
                setFormData({
                  fullName: '', mobile: '', email: '', parentName: '', parentMobile: '',
                  class: '', target: '', mode: '', previousScore: '', address: '',
                  scholarship: 'No', referredBy: '', declaration: false
                });
                setIsSuccess(false);
                setStep(1);
              }}
              className="group flex items-center justify-center gap-3 w-full bg-brand-red text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all duration-500 shadow-xl shadow-brand-red/20"
            >
              Fill Another Form
              <Sparkles size={20} />
            </button>
  ...
  return (
    <div className="min-h-screen bg-brand-gray pt-12 pb-10 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative z-10">
        ...
        <div className="lg:col-span-5 pt-6">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black text-brand-dark uppercase tracking-tighter leading-[0.9] mb-8 animate-fade-up stagger-1">
            Build Your <br />
          ...
          <p className="text-base sm:text-lg text-gray-500 font-medium max-w-md mb-12 animate-fade-up stagger-2 leading-relaxed">
            ...
            {[
              ...
              <div key={s.id} className="flex gap-6 group">
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center font-black text-xl transition-all duration-500 shadow-lg ${
                  ...
                  step > s.id ? 'bg-green-500 text-white shadow-green-500/20' : 'bg-gray-200 text-gray-500'
                }`}>
        ...
        <div className="lg:col-span-7">
          <form 
            ...
            className="bg-white rounded-[40px] md:rounded-[60px] shadow-[0_40px_100px_-30px_rgba(0,0,0,0.15)] overflow-hidden border border-gray-100/50 animate-fade-scale"
          >
            {/* --- INSTITUTIONAL LETTERHEAD --- */}
            <div className="bg-[#fcfcfc] border-b-[6px] border-double border-[#800000] p-6 md:p-10 relative">
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-4">
                {/* Left: English Headings */}
                <div className="text-center md:text-left md:flex-1">
                  <h2 className="text-base md:text-xl font-black text-black uppercase tracking-wide whitespace-nowrap" style={{ fontFamily: "'Times New Roman', serif" }}>
                    <span className="text-brand-red">BK</span> EDUCATIONAL & WELFARE SOCIETY
                  </h2>
                  <h4 className="text-[9px] md:text-xs font-bold text-black uppercase tracking-[0.2em] opacity-80 mt-1" style={{ fontFamily: "'Times New Roman', serif" }}>
                    <span className="text-brand-red">BK</span> GROUP OF EDUCATION
                  </h4>
                </div>

                {/* Center: BK Logo & Taglines */}
                <div className="flex flex-col items-center gap-2 relative md:px-6 order-first md:order-none">
                   <div className="relative z-10 text-center space-y-1">
                      <p className="text-[10px] font-black text-gray-700 tracking-widest">॥ न हि ज्ञानेन सदृशं पवित्रमिह विद्यते ॥</p>
                      <p className="text-sm text-[#800000] font-black uppercase tracking-widest">We shape careers...</p>
                   </div>
                   
                   <div className="relative z-10 flex items-center justify-center mt-2">
                      <SafeImage src="/assets/bk.png" className="h-16 md:h-20 w-auto object-contain drop-shadow-lg" fallbackText="BK" />
                   </div>
                </div>

                {/* Right: Address */}
                <div className="text-center md:flex-1 md:flex md:justify-end">
                  <p className="text-[12px] md:text-lg font-bold text-gray-900 leading-relaxed max-w-[300px] text-left uppercase tracking-wider">
                    Address: 2nd Floor, Gajanan Plaza, Gharpure Ghat Road, Ashok Stambh, Nashik, Maharashtra
                  </p>
                </div>
              </div>
            </div>
              ...
              {step === 1 && (
                <div className="space-y-6 animate-fade-up">
                  ...
                  <button 
                    type="button"
                    onClick={nextStep}
                    className={`group flex items-center justify-center gap-3 w-full bg-brand-red text-white py-3 rounded-3xl font-black uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-brand-red/30 ${!otpVerified ? 'opacity-50 cursor-not-allowed grayscale' : ''}`}
                  >
                ...
                <div className="space-y-6 animate-fade-up">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button 
                      type="button"
                      onClick={nextStep}
                      className="group flex items-center justify-center gap-3 flex-1 bg-brand-red text-white py-3 rounded-3xl font-black uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-brand-red/30"
                    >
                      Next Step
                      <ChevronRight size={20} className="group-hover:translate-x-2 transition-transform" />
                    </button>
                  ...
                  <div className="flex flex-col gap-2 group relative">
                    ...
                    <div className="relative overflow-hidden rounded-2xl">
                      ...
                      <textarea 
                        ...
                        rows="4"
                        className="w-full bg-white border-2 border-gray-300 rounded-2xl pl-14 pr-6 py-4 font-bold text-brand-dark focus:border-brand-red focus:bg-white transition-all duration-500 text-sm shadow-sm hover:shadow-md outline-none resize-none placeholder:text-gray-400"
                      />
                      <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-brand-red group-focus-within:w-full transition-all duration-700 ease-out"></div>
                    </div>
                  </div>
